package com.example.adminpoker.Adapter;
...
public class QuestionListAdapter extends RecyclerView.Adapter<QuestionListAdapter.ViewHolder> {
    ...
    public QuestionListAdapter(List<Question> questionList, Context context, com.example.adminpoker.Interfaces.onClickInterface onClickInterface) {
